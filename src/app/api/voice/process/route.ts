...
3. Si el usuario quiere navegar, identifica la sección (entrantes, bocadillos, bebidas, postres, carrito, cuenta).
4. El idioma de salida del JSON debe ser consistente con los IDs del sistema, independientemente del idioma del cliente.
